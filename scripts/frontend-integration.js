 ...
 * This file demonstrates how to integrate Echolearn with a web frontend
 */

// For React/Vue/Angular applications
export class EcholearnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EcholearnClient(provider, contractAddress);
